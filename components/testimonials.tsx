...
const testimonials = [
  {
    ...
    post: "Tech Lead",
    content:
      "With deep experience in Project handling fulfilling the client exprectations, Pratik leads the development of scalable web as well android ios applications. His ability to architect robust full-stack solutions makes him a cornerstone of our development team.",
    categories: [1, 3, 5],
  },
  {
    ...
    name: "Nitish Mishra",
    post: "React & Next.js Developer",
    content:
      "Nitish specializes in crafting modern and fast-performing web apps using React and Next.js. His frontend skills ensure our interfaces are not only sleek but also user-friendly and SEO-optimized",
    categories: [1, 2, 4],
  },
  {
    ...
    name: "Yashaswi Sahu",
    post: "MERN Stack Developer & Client Manager",
    content:
      "Yashaswi combines technical expertise with excellent communication skills. He not only builds full-stack solutions but also bridges the gap between technical teams and clients, ensuring smooth project delivery.",
    categories: [1, 2, 5],
  },
  {
    ...
    name: "Abhishek Verma",
    post: "Three js Developer",
    content:
      "Abhishek brings life to the web with immersive 3D experiences using Three.js. His creativity also shines through in his design work, giving our products a unique visual edge.",
    categories: [1, 4],
  },
  {
    ...
    content:
      "Ehthesham is our backend expert in PHP, ensuring reliable, secure, and high-performing web services. From custom CMS to dynamic websites, he handles it all with precision.",
    categories: [1, 3, 5],
  },
  {
    img: TestimonialImg06,
    clientImg: ClientImg06,
    name: "Dageshver Manikpuri",
    post: "Maffell",
    content:
      "Senior Backend Developer & DevOps Engineer Dageshver excels in building powerful backend systems and maintaining smooth DevOps pipelines. His expertise ensures our infrastructure is reliable, scalable, and ready for production at all times.",
    categories: [1, 3],
  },
  {
    ...
    name: "Srijan verma",
    post: "Game Design & Environment Artist",
    content:
      "Sriajn turns ideas into immersive worlds. With a keen eye for visual storytelling, he specializes in creating stunning game environments that captivate players and enhance the gaming experience.",
    categories: [1, 2, 5],
  },
];
      ...
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          ...
          <p className="text-lg text-indigo-200/65">
            We are the decision makers, professionals who bring diverse
            expertise to the table. Get to know the talented individuals
    ...
    >
      <div className="flex flex-col gap-4">
        ...
        <div className="flex items-center gap-3">
          <Image
            className="inline-flex shrink-0 w-8 h-8 object-cover rounded-full"
            src={testimonial.img}
            // width={36}
            // height={36}
